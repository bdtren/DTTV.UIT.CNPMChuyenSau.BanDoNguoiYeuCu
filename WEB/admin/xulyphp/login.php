   ...
   if (isset($_POST['login'])) 
    {     
        ...
        else
        {
            ...
            switch($row['MACV'])
            {
                case 'CV0002': header("Location: advertisement/index.php") ;break;
                case 'CV0004': header("Location: censorship/index.php") ;break;
                case 'CV0003': header("Location: customercare/index.php") ;break;
                case 'CV0005': header("Location: finance/index.php") ;break;
            }
        }    
        mysqli_close($conn);
    }
