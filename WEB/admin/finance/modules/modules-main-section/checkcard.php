    ...
    <table id="content-table" class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-warning" data-toggle="modal" href="#" style="color:white;" data-target="#see" onclick="openModelTheCao(<?php echo $i/*$a[$i]['MAPH']*/?>)">Kiểm tra</a>
          </td>
        </tr>
...
<!-- Modal -->
<!-- Bài đăng cần duyệt -->
<div class="modal fade modal-change" id="see" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
