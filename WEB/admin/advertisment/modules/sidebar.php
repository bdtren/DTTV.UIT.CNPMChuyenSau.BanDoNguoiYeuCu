<!-- Sidebar -->
						    ...
						    <div class="list-group">
								...
								<a href="index.php?page=promotion" class="list-group-item list-group-item-action"><i class="fa fa-pencil"></i>  Khuyến mãi <span class="badge badge-danger" style="float: right;">10</span></a>
